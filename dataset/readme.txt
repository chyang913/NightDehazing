The images in the real-world dataset are collected from the following sources.
...
3. dataset3 dataset3 (104 images selected from https://sites.google.com/view/reside-dehaze-datasets , the filenames of the 104 images are listed in the (NightDehazing/dataset/list.txt) `list.txt` above.)
